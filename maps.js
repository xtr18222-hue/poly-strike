...
(function (root, factory) {
  ...
  const range = {
    ...
    spawnBots: [
      // Each stationary pad performs a distinct clip from the Pro Rifle Pack so
      // the whole locomotion suite can be verified at a glance from the
      // top-down camera.
      { x: 0, z: 14, anim: 'idleAim' }, { x: -8, z: 6, anim: 'run' },
      { x: 8, z: 6, anim: 'walkRight' }, { x: -16, z: -10, anim: 'slide' },
      { x: 16, z: -10, anim: 'crouchAim' }, { x: 0, z: -24, anim: 'lay' },
    ],
    solids: [
  ...
  const depot = {
    ...
    spawnBots: [
      { x: -6, z: 2, anim: 'idle' }, { x: 6, z: 2, anim: 'runBack' },
      { x: 0, z: -4, anim: 'crouchWalk' }, { x: -8, z: -10, anim: 'lay' },
      { x: 8, z: -10, anim: 'sprint' },
    ],
    solids: [
