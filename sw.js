const CACHE='poly-strike-v2-field-operations';
const FILES=['./','./index.html','./style.css','./vendor/three.min.js','./maps.js','./core.js','./visuals.js','./audio.js','./settings.js','./vendor/peerjs.min.js','./net.js','./duel.js','./online.js','./game.js'];
