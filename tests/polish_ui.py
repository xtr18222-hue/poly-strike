...
with sync_playwright() as p:
 ...
 assert page.locator('#mainActions button').all_text_contents()==['Play Offline (vs Bots)','Play Online','Loadout','Store','Settings']
 page.locator('#fallback').check();page.locator('#start').click();page.keyboard.down('Tab');page.wait_for_timeout(200)
