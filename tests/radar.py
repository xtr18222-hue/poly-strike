...
with sync_playwright() as p:
 ...
 page.evaluate('Game.test.bot(0,0,14)');page.wait_for_timeout(150)
 assert pixel(0,14)[:3]==[255,115,94],pixel(0,14)
 page.evaluate('Game.test.bot(0,4,14)');page.wait_for_timeout(150);assert pixel(4,20)[:3]==[217,245,119]
